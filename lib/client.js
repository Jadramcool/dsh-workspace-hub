window.__ModuleLoader__.load({
  ...
  factory: (require) => {
    ...
    .wsfm-slist{margin:3px 0 5px 16px;padding:3px 0 3px 10px}
    .wsfm-sess{position:relative;display:flex;flex-direction:column;gap:3px;padding:8px 10px 8px 22px;border-radius:8px;cursor:grab;margin:3px 0;transition:background .12s ease}
    .wsfm-sess.editing{flex-direction:row;align-items:center;gap:8px;padding:6px 8px}
    .wsfm-sess.editing .wsfm-st{display:none}
    ...
    .wsfm-sess-row1{display:flex;align-items:center;gap:6px;min-width:0;padding-right:52px}
    .wsfm-sess-row2{display:flex;align-items:center;gap:6px;padding-left:2px}
    ...
    .wsfm-st{position:absolute;left:10px;top:50%;transform:translateY(-50%);width:7px;height:7px;border-radius:50%;flex:none;transition:transform .15s ease}
    .wsfm-sess:hover .wsfm-st{transform:translateY(-50%) scale(1.25)}
