window.__ModuleLoader__.load({
  ...
  factory: (require) => {
    ...
    .wsfm-sess{position:relative;display:flex;flex-direction:column;gap:3px;padding:8px 10px;border-radius:8px;cursor:grab;margin:3px 0;transition:background .12s ease}
    ...
    .wsfm-sess-row2{display:flex;align-items:center;gap:6px;padding-left:14px}
