window.__ModuleLoader__.load({
  ...
  factory: (require) => {
    ...
    .wsfm-sess{position:relative;display:flex;flex-direction:column;gap:2px;padding:6px 9px;border-radius:8px;cursor:grab;margin:2px 0;transition:background .12s ease}
    .wsfm-sess.editing{flex-direction:row;align-items:center;gap:8px}
    ...
    .wsfm-sess-row2{display:flex;align-items:center;gap:6px;padding-left:16px}
    ...
    .wsfm-sacts{visibility:hidden;opacity:0;position:absolute;top:4px;right:4px;display:flex;align-items:center;gap:1px;transition:opacity .12s ease;background:inherit}
